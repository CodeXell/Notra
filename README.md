...
GSD is a basic Note-Taking Utility app.
GSD is also a utility application that will provide you various services across a series of categories from legal to business to labour. We can provide online services that you need completed but don't have the time to do.
...
We recommend downloading the latest installer after every major update. We will regularly release new and useful features as minor updates, updating on these is optional.\
